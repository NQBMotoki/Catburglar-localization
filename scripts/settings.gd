...
var language : int = Language.ENGLISH
...
func apply_language_setting() -> void:
	TranslationServer.set_locale("en" if language == Language.ENGLISH else "zh_CN")
...
func load_settings() -> void:
	...
	language = config_file.get_value("game", "language", Language.ENGLISH)
