...
enum Menu {MAIN, CREDITS, SETTINGS, GRAPHICS, AUDIO, CONTROLS, LANGUAGE}
...
@onready var language_menu : Control = $Menus/Language
...
func set_active_menu(menu : int) -> void:
	...
	language_menu.visible = menu == Menu.LANGUAGE
	language_menu.active = menu == Menu.LANGUAGE
...
func _ready() -> void:
	...
	prompt_select.title = "Select"
	prompt_back.title = "Back"
